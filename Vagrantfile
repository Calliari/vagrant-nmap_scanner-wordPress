...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", path: "apache2_provision.sh" #, privileged: false
  config.vm.provision "shell", path: "mysql_provision.sh" #, privileged: false
  # config.vm.provision "shell", path: "wordpress_provision.sh" #, privileged: false
  config.vm.provision "shell", path: "jenkins_provision.sh" #, privileged: false
